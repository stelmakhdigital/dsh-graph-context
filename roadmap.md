...
Обновлено: 2026-09-15 · Статус: **v0.6.1 выпущен** (P2c: #3 graph_blast + resume-blast live ✅, #4 Code Mode ✅ по докам+guard); **стоп до остатка P2c** (change control)
