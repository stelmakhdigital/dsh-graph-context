...
Обновлено: 2026-09-15 · Статус: **v0.7.0 выпущен** (P2c: #3 graph_blast live ✅, #4 Code Mode ✅, #7 local --deep ✅); **стоп до #17 watcher** (change control)
